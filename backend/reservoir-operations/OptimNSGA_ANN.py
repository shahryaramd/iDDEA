...
fname =os.path.join(homedir,"ANN_Detroit/Det.ANNForecast" )  # "/home/shahryar/DSS/ANN_Detroit/ANNForecastHistory/20190529.Det.ANNForecast" #
...
opath = os.path.join(homedir,"ANN_Detroit/OptimData/")
